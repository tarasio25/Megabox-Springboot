...
<body _c_t_common="1">
    ...
    <div class="skip" title="스킵 네비게이션">
        <a href="https://www.megabox.co.kr/#contents" title="본문 바로가기">본문 바로가기</a>
        <a href="https://www.megabox.co.kr/#footer" title="푸터 바로가기">푸터 바로가기</a>
    </div>
...
<!-- 화면ID  M-ME-LO-01 -->
<!-- 화면ID  M-ME-CC-01 -->
<div style="display:none;"><a id="loginPupupATag" href="https://www.megabox.co.kr/#layer_login_select" class="button active btn-modal-open" w-data="850" h-data="484"></a></div>

	<section id="layer_login_select" class="modal-layer" style="z-index: 501;"><a href="https://www.megabox.co.kr/" class="focus">레이어로 포커스 이동 됨</a><a href="https://www.megabox.co.kr/#" class="focus" title="레이어로 포커스 이동 됨">레이어로 포커스 이동 됨<!--레이어로 포커스 이동 됨--></a>
		<div class="wrap" style="width: 850px; height: 556px; margin-left: -425px; margin-top: -278px;">
			...
			<div class="layer-con" style="height: 511px;">
				...
				<div class="tab-list tab-layer">
					<ul>
						<li class="on"><a href="https://www.megabox.co.kr/#login_tab_01" title="회원 로그인 선택">회원 로그인<!--회원 로그인--></a></li>
						<li><a href="https://www.megabox.co.kr/#login_tab_02" title="비회원 로그인 선택">비회원 로그인<!--비회원 로그인--></a></li>
					</ul>
				</div>
				...
				<div class="tab-cont-wrap">
					<!-- tab 회원 로그인 -->
					<div id="login_tab_01" class="tab-cont on"><a href="https://www.megabox.co.kr/" class="ir"></a><a href="https://www.megabox.co.kr/" class="ir" title="로그인"></a>
							...
							<div class="col-wrap">
								<div class="col left">
									<div class="login-input-area">
										...
										<div class="link">
											<a href="https://www.megabox.co.kr/user-find" title="ID/PW 찾기 선택">ID/PW 찾기<!--ID/PW 찾기--></a>
											<a href="https://www.megabox.co.kr/join" title="회원가입 선택">회원가입<!--회원가입--></a>
											<a href="https://www.megabox.co.kr/on/oh/ohg/MbLogin/viewNonMbLogin.rest" title="비회원 예매확인 선택">비회원 예매확인<!--비회원 예매확인--></a>
										</div>

										<div class="sns-login">
											<a href="javaScript:void(0)" lnkgty="FACEBOOK" title="페이스북으로 로그인 선택"><img src="resources/main_files/ico-facebook.png" alt="페이스북"><!--페이스북--> 페이스북으로 로그인<!--페이스북으로 로그인--></a>
											<a href="javaScript:void(0)" lnkgty="NAVER" title="네이버로 로그인 선택"><img src="resources/main_files/ico-naver.png" alt="네이버"><!--네이버-->   네이버로 로그인<!--네이버로 로그인--></a>
											<a href="javaScript:void(0)" lnkgty="KAKAO" title="카카오톡으로 로그인 선택"><img src="resources/main_files/ico-kakao.png" alt="카카오톡"><!--카카오톡--> 카카오톡으로 로그인<!--카카오톡으로 로그인--></a>
											<a href="javaScript:void(0)" lnkgty="PAYCO" title="페이코로 로그인 선택"><img src="resources/main_files/ico-payco.png" alt="페이코"><!--페이코-->   페이코로 로그인<!--페이코로 로그인--></a>
										</div>
									</div>
								</div>
					...
					<!-- tab 비회원 로그인 -->
					<div id="login_tab_02" class="tab-cont"><a href="https://www.megabox.co.kr/" class="ir"></a><a href="https://www.megabox.co.kr/" class="ir" title="비회원 로그인"></a>
						...
						<div class="login-member col-2">
							...
							<div class="btn-group">
								...
								<a id="aNonMbLogin" href="https://www.megabox.co.kr/#layer_no_member_chk" class="button purple btn-modal-open" w-data="600" h-data="320" style="display: none;"></a>
							</div>
						</div>
					</div>
					<!--// tab 비회원 로그인 -->
...
<h1 class="ci"><a href="https://www.megabox.co.kr/" title="MEGABOX 메인으로 가기">MEGABOX : Life Theater</a></h1>
    ...
    <div class="link-area">
        ...
        <a href="https://www.megabox.co.kr/#layer_mymega" class="header-open-layer btn-layer-mymega" title="나의 메가박스">나의 메가박스</a>
    </div>
	...
	<div id="layer_sitemap" class="header-layer layer-sitemap">
        <!-- wrap -->
        <div class="wrap">
            <a href="https://www.megabox.co.kr/" class="link-acc" title="사이트맵 레이어 입니다.">사이트맵 레이어 입니다.</a>
            ...
            <div class="list position-6">
                ...
                <ul class="list-depth mymage">
            				...
            				<li><a href="https://www.megabox.co.kr/mypage" title="나의 메가박스 홈">나의 메가박스 홈</a></li>
		                    <li><a href="https://www.megabox.co.kr/mypage/bookinglist" title="예매/구매내역">예매/구매내역</a></li>
		                    <li><a href="https://www.megabox.co.kr/mypage/movie-coupon" title="영화관람권">영화관람권</a></li>
		                    <li><a href="https://www.megabox.co.kr/mypage/store-coupon" title="스토어교환권">스토어교환권</a></li>
		                    <li><a href="https://www.megabox.co.kr/mypage/discount-coupon" title="할인/제휴쿠폰">할인/제휴쿠폰</a></li>
		                    <!-- <li><a href="/on/oh/ohh/Mvtckt/GiftCardL.do">기프트카드</a></li> -->
		                    <li><a href="https://www.megabox.co.kr/mypage/point-list" title="멤버십포인트">멤버십포인트</a></li>
		                    <li><a href="https://www.megabox.co.kr/mypage/moviestory" title="나의 무비스토리">나의 무비스토리</a></li>
		                    <li><a href="https://www.megabox.co.kr/mypage/myevent" title="나의 이벤트 응모내역">나의 이벤트 응모내역</a></li>
		                    <li><a href="https://www.megabox.co.kr/mypage/myinquiry" title="나의 문의내역">나의 문의내역</a></li>
		                    <li><a href="https://www.megabox.co.kr/mypage/mydiscount" title="자주쓰는 할인 카드">자주쓰는 할인 카드</a></li>
		                    <li><a href="https://www.megabox.co.kr/on/oh/ohh/Mypage/mainPage.do?returnURL=info" title="회원정보">회원정보</a></li>
            ...
            <div class="ir">
                <a href="https://www.megabox.co.kr/" class="layer-close" title="레이어닫기">레이어닫기</a>
            </div>
        </div>
        <!--// wrap -->
    </div>
	...
	<div id="layer_mymega" class="header-layer layer-mymege">
    	<a href="https://www.megabox.co.kr/" class="ir" title="나의 메가박스 레이어 입니다.">나의 메가박스 레이어 입니다.</a>
        ...
        <div class="wrap" style="display:none">
            ...
            <div class="login-before">
                ...
                <div class="mb50">
                    <a href="https://www.megabox.co.kr/#layer_login_common" id="moveLogin" title="로그인" class="button w120px btn-modal-open" w-data="850" h-data="484">로그인</a>
                </div>
    ...
    <section id="new">
            <div class="row">
                <div class="new">
                    ...
                    <div class="new_right">
                        <h3 class="title">범죄도시2</h3>
                        <span class="release">2022년 05월 18일 개봉</span>
                        <div class="star">
                        ...
                        <ul class="summary">
                            <li class="genre"><span class="bar">범죄  /  </span><span>대한민국</span></li>
                            <li class="age"><span class="bar">106분  /  </span><span>15세 이상 관람가</span></li>
                            <li class="desc">가리봉동 소탕작전 후 4년 뒤, 금천서 강력반은 베트남으로 도주한 용의자를 인도받아 오라는 미션을 받는다. 괴물형사 ‘마석도’(마동석)와 ‘전일만’(최귀화) 반장은 현지 용의자에게서 수상함을 느끼고, 그의 뒤에 무자비한 악행을 벌이는 ‘강해상’(손석구)이 있음을 알게 되는데..</li>
                        </ul>
                        <div class="select">
                            <div class="s1">
                                <label for="udate" class="ir_so">날짜</label>
                                <input type="text" id="udate" name="udate" value="2022년 5월 22일" class="ui_select2">
                            </div>
                            <div class="s2">
