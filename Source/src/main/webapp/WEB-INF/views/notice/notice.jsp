...
<link rel="stylesheet" href="resources/notice_files/megabox.min.css" media="all">
...
$(function(){
		...
		//다시보지 않기
		 if (fn_getCookie("BROWDER_DL") == null || fn_getCookie("BROWDER_DL") == 'N') {
			...
			<div class="ie-update">
				...
				<div class="wrap">
					<p class="tit">
						<img src="resources/notice_files/txt-update.png"
						...
						<div class="col">
							...
							<div class="link">
								<a
									...
									src="resources/notice_files/btn-ie.png"
							...
							<div class="link">
								<a href="http://www.google.com/chrome?hl=ko" title="chrome 다운로드"
									target="_blank"> <img src="resources/notice_files/btn-chrome.png"
									alt="chrome 다운로드">
								</a>
							</div>
						</div>
						...
						<div class="col">
							...
							<div class="link">
								<a
									...
									src="resources/notice_files/btn-appstore.png"
							...
							<div class="link">
								<a
									...
									src="resources/notice_files/btn-google.png"
	...
	$(function() {
		...
		$('.tabBtn').on('click', function() {
			var no = $(this).find('button').data('no');

			// 탭클릭시 검색조건 초기화
			$('#theater').val('').change();
			$('#theater02').val('').change();
			$('#searchTxt').val('');
			$('[name=currentPage]').val(1);

			if(no != undefined && no != '') {
				fn_selectIrList($(this).find('button').data('no'));
			} else {
				fn_selectIrList();
			}

			if(no == 81) {
				$('#theater, #theater02').selectpicker('hide');
			} else {
				$('#theater, #theater02').selectpicker('show');
			}
		});

		// 검색 클릭
		$('#searchBtn').on('click', function() {
			if ($('#theater').val() != '' && $('#theater02').val() == '') {
				gfn_alertMsgBox('극장을 선택해 주세요.');
				return;
			}

			// 검색시 전체검색
			//if($('#searchTxt').val() != '') {
				$('.tabBtn.on').removeClass('on');
	...
	function fn_resetTheater() {
		...
		$('#theater02').append($('<option>').val('').text('극장 선택'));
	...
	// 영화관 코드 목록 조회 함수
	function fn_searchTheaterList(cd) {
		$.ajaxMegaBox({
		 	url: '/on/oh/ohj/Company/theaterCdList.do',
		 	data: JSON.stringify({ areaCd: cd }),
		 	success: function(result) {
		 		...
		 		MegaboxUtil.Common.refreshSelectBox($('#theater02'));
		  	}
		});
	}

	// 게시글 목록 조회
	function fn_selectIrList(cateNo) {
		var currentPage = $('[name=currentPage]').val() ? $('[name=currentPage]').val() : 1;
		var cate2No = cateNo && cateNo == '81' ? '' : $('#theater02').val();

		var params = {
			cateNo: cateNo ? cateNo : '',
			cate2No: cate2No,
			searchTxt: $('#searchTxt').val()
		};

		var options = {};
		options.url = '/on/oh/ohi/CustCen/customerNoticeList.do';
		options.paramData = params;
		options.currentPage = currentPage;

		var noticeOption = {type : {tag : 'span', css : 'font-green'}, regTxt : $('#searchTxt').val()};
		...
		options.successCallBack = function(data) {
			...
			$('.result-count').html('<strong>전체 ' + '<em class="font-gblue">' + Number(totCount).format() + '</em>' + '건</strong>');

			if(data.boardList.length > 0) {
				var tr, td1, td2, td3, td4, th, a;

				target.find('tr').remove();

				$.each(data.boardList, function(i, v) {
					tr = $('<tr>');
					a = $('<a>').attr({ 'href': '#', 'class': 'moveBtn', 'data-no': v.artiNo, 'title': '공지사항 상세보기' }).html(gfn_getTighlight(noticeOption, v.artiTitle));
					td1 = $('<td>').text(v.rowNum);
					td2 = $('<td>').html(v.cateNo1 == 81 ? v.cateNm : v.cate2Nm);
					td3 = $('<td>').text(v.cate3Nm);
					td4 = $('<td>').text(v.fstRegDtStr);
					th = $('<th>').append(a);

					tr.append(td1).append(td2).append(td3).append(th).append(td4);
					target.append(tr);
				});
				...
				tr = $('<tr>');
				td1 = $('<td>').attr('colspan', 5).text('목록이 없습니다.');
	...
	function fn_bindMoveEvent() {
		$('.moveBtn').off();
		$('.moveBtn').on('click', function(e) {
			e.preventDefault();

			//$('[name=artiNo]').val($(this).data('no'));
			$('[name=cateNo]').val($('.tabBtn.on').find('button').data('no'));
			$('[name=theater]').val($('#theater').val());
			$('[name=theater02]').val($('#theater02').val());
			$('[name=cate2No]').val($('#theater02').val());
			$('[name=searchTxt]').val($('#searchTxt').val());
			$('[name=currentPage]').val($('.pagination .active').text());

			var artiNo = $(this).data('no');

			var form = $(document.forms.moveFrm);
			form.attr('action', '/support/notice/detail?artiNo='+artiNo);
			form.submit();
		});
	}
</script>
		...
		<div class="container has-lnb">
			<div class="page-util">
				<div class="inner-wrap">
					<div class="location">
						<span>Home</span> <a href="#">관리자 페이지</a> <a
							href="#">영화이름 리스트</a>
					</div>
				...
				<div class="lnb-area addchat">
					<nav id="lnb">
						...
						<ul>
							...
							<li class="on"><a
								href="https://www.megabox.co.kr/support/notice" title="공지사항">공지사항</a></li>
							<li><a href="https://www.megabox.co.kr/support/inquiry"
								title="1:1문의">1:1문의</a></li>
							<li><a href="https://www.megabox.co.kr/support/rent"
						...
						<table class="board-list">
							...
							<tbody>
								<tr>
									...
									<td>청라지젤</td>
									<td>공지</td>
									<th><a href="https://www.megabox.co.kr/support/notice#"
										class="moveBtn" data-no="10568" title="공지사항 상세보기"><span
											class="font-green"></span>[<span class="font-green"></span>청<span
											class="font-green"></span>라<span class="font-green"></span>지<span
											class="font-green"></span>젤<span class="font-green"></span>]<span
											class="font-green"></span> <span class="font-green"></span>5<span
											class="font-green"></span>/<span class="font-green"></span>1<span
											class="font-green"></span>0<span class="font-green"></span>(<span
											class="font-green"></span>화<span class="font-green"></span>)<span
											class="font-green"></span>~<span class="font-green"></span>5<span
											class="font-green"></span>/<span class="font-green"></span>1<span
											class="font-green"></span>2<span class="font-green"></span>(<span
											class="font-green"></span>목<span class="font-green"></span>)<span
											class="font-green"></span> <span class="font-green"></span>로<span
											class="font-green"></span>비<span class="font-green"></span>공<span
											class="font-green"></span>사<span class="font-green"></span>로<span
											class="font-green"></span> <span class="font-green"></span>인<span
											class="font-green"></span>한<span class="font-green"></span> <span
											class="font-green"></span>매<span class="font-green"></span>점<span
											class="font-green"></span>운<span class="font-green"></span>영<span
											class="font-green"></span> <span class="font-green"></span>임<span
											class="font-green"></span>시<span class="font-green"></span>중<span
											class="font-green"></span>단<span class="font-green"></span> <span
											class="font-green"></span>안<span class="font-green"></span>내<span
											class="font-green"></span></a></th>
									<td>2022.05.10</td>
								</tr>
								<tr>
									<td>2</td>
									...
									<td>공지</td>
									<th><a href="https://www.megabox.co.kr/support/notice#"
										class="moveBtn" data-no="10567" title="공지사항 상세보기"><span
											class="font-green"></span>[<span class="font-green"></span>세<span
											class="font-green"></span>종<span class="font-green"></span>나<span
											class="font-green"></span>성<span class="font-green"></span>]<span
											class="font-green"></span> <span class="font-green"></span>영<span
											class="font-green"></span>화<span class="font-green"></span> <span
											class="font-green"></span>관<span class="font-green"></span>람<span
											class="font-green"></span>요<span class="font-green"></span>금<span
											class="font-green"></span> <span class="font-green"></span>변<span
											class="font-green"></span>경<span class="font-green"></span> <span
											class="font-green"></span>안<span class="font-green"></span>내<span
											class="font-green"></span></a></th>
									<td>2022.05.09</td>
								</tr>
								<tr>
									...
									<td>공지</td>
									<th><a href="https://www.megabox.co.kr/support/notice#"
										class="moveBtn" data-no="10566" title="공지사항 상세보기"><span
											class="font-green"></span>[<span class="font-green"></span>대<span
											class="font-green"></span>전<span class="font-green"></span>현<span
											class="font-green"></span>대<span class="font-green"></span>아<span
											class="font-green"></span>울<span class="font-green"></span>렛<span
											class="font-green"></span>]<span class="font-green"></span> <span
											class="font-green"></span>영<span class="font-green"></span>화<span
											class="font-green"></span> <span class="font-green"></span>관<span
											class="font-green"></span>람<span class="font-green"></span>요<span
											class="font-green"></span>금<span class="font-green"></span> <span
											class="font-green"></span>변<span class="font-green"></span>경<span
								...
								<tr>
									...
									<td>공지</td>
									<th><a href="https://www.megabox.co.kr/support/notice#"
										class="moveBtn" data-no="10565" title="공지사항 상세보기"><span
											class="font-green"></span>[<span class="font-green"></span>대<span
											class="font-green"></span>전<span class="font-green"></span>중<span
											class="font-green"></span>앙<span class="font-green"></span>로<span
											class="font-green"></span>]<span class="font-green"></span> <span
											class="font-green"></span>영<span class="font-green"></span>화<span
											class="font-green"></span> <span class="font-green"></span>관<span
											class="font-green"></span>람<span class="font-green"></span>요<span
								...
								<tr>
									...
									<td>공지</td>
									<th><a href="https://www.megabox.co.kr/support/notice#"
										class="moveBtn" data-no="10564" title="공지사항 상세보기"><span
											class="font-green"></span>[<span class="font-green"></span>대<span
											class="font-green"></span>전<span class="font-green"></span>유<span
											class="font-green"></span>성<span class="font-green"></span>]<span
											class="font-green"></span> <span class="font-green"></span>영<span
											class="font-green"></span>화<span class="font-green"></span> <span
											class="font-green"></span>관<span class="font-green"></span>람<span
								...
								<tr>
									...
									<td>공지</td>
									<th><a href="https://www.megabox.co.kr/support/notice#"
										class="moveBtn" data-no="10563" title="공지사항 상세보기"><span
											class="font-green"></span>[<span class="font-green"></span>대<span
											class="font-green"></span>전<span class="font-green"></span>신<span
											class="font-green"></span>세<span class="font-green"></span>계<span
											class="font-green"></span> <span class="font-green"></span>아<span
											class="font-green"></span>트<span class="font-green"></span>앤<span
											class="font-green"></span>사<span class="font-green"></span>이<span
											class="font-green"></span>언<span class="font-green"></span>스<span
											class="font-green"></span>]<span class="font-green"></span> <span
											class="font-green"></span>영<span class="font-green"></span>화<span
											class="font-green"></span> <span class="font-green"></span>관<span
											class="font-green"></span>람<span class="font-green"></span>요<span
								...
								<tr>
									...
									<td>공지</td>
									<th><a href="https://www.megabox.co.kr/support/notice#"
										class="moveBtn" data-no="10562" title="공지사항 상세보기"><span
											class="font-green"></span>[<span class="font-green"></span>대<span
											class="font-green"></span>전<span class="font-green"></span>]<span
											class="font-green"></span> <span class="font-green"></span>영<span
											class="font-green"></span>화<span class="font-green"></span> <span
											class="font-green"></span>관<span class="font-green"></span>람<span
											class="font-green"></span>요<span class="font-green"></span>금<span
								...
								<tr>
									...
									<td>공지</td>
									<th><a href="https://www.megabox.co.kr/support/notice#"
										class="moveBtn" data-no="10561" title="공지사항 상세보기"><span
											class="font-green"></span>[<span class="font-green"></span>청<span
											class="font-green"></span>라<span class="font-green"></span>지<span
											class="font-green"></span>젤<span class="font-green"></span>]<span
											class="font-green"></span>5<span class="font-green"></span>/<span
											class="font-green"></span>9<span class="font-green"></span>(<span
											class="font-green"></span>월<span class="font-green"></span>)<span
											class="font-green"></span>~<span class="font-green"></span>5<span
											class="font-green"></span>/<span class="font-green"></span>1<span
											class="font-green"></span>2<span class="font-green"></span>(<span
											class="font-green"></span>목<span class="font-green"></span>)<span
											class="font-green"></span> <span class="font-green"></span>운<span
											class="font-green"></span>영<span class="font-green"></span>시<span
											class="font-green"></span>간<span class="font-green"></span> <span
											class="font-green"></span>공<span class="font-green"></span>지<span
											class="font-green"></span></a></th>
									<td>2022.05.09</td>
								</tr>
								<tr>
									...
									<td>공지</td>
									<th><a href="https://www.megabox.co.kr/support/notice#"
										class="moveBtn" data-no="10560" title="공지사항 상세보기"><span
											class="font-green"></span>[<span class="font-green"></span>코<span
											class="font-green"></span>엑<span class="font-green"></span>스<span
											class="font-green"></span>지<span class="font-green"></span>점<span
											class="font-green"></span>]<span class="font-green"></span> <span
											class="font-green"></span>&lt;<span class="font-green"></span>범<span
											class="font-green"></span>죄<span class="font-green"></span>도<span
											class="font-green"></span>시<span class="font-green"></span>2<span
											class="font-green"></span>&gt;<span class="font-green"></span>
											<span class="font-green"></span>시<span class="font-green"></span>사<span
											class="font-green"></span>회<span class="font-green"></span> <span
											class="font-green"></span>진<span class="font-green"></span>행<span
											class="font-green"></span>에<span class="font-green"></span> <span
											class="font-green"></span>따<span class="font-green"></span>른<span
											class="font-green"></span> <span class="font-green"></span>고<span
											class="font-green"></span>객<span class="font-green"></span> <span
											class="font-green"></span>안<span class="font-green"></span>내<span
											class="font-green"></span>문<span class="font-green"></span> <span
											class="font-green"></span>(<span class="font-green"></span>5<span
											class="font-green"></span>/<span class="font-green"></span>1<span
											class="font-green"></span>1<span class="font-green"></span>)<span
											class="font-green"></span></a></th>
									<td>2022.05.09</td>
								</tr>
								<tr>
									...
									<td>공지</td>
									<th><a href="https://www.megabox.co.kr/support/notice#"
										class="moveBtn" data-no="10559" title="공지사항 상세보기"><span
											class="font-green"></span>&lt;<span class="font-green"></span>민<span
											class="font-green"></span>스<span class="font-green"></span>미<span
											class="font-green"></span>트<span class="font-green"></span> <span
											class="font-green"></span>작<span class="font-green"></span>전<span
											class="font-green"></span>&gt;<span class="font-green"></span>
											<span class="font-green"></span>빵<span class="font-green"></span>원<span
											class="font-green"></span>티<span class="font-green"></span>켓<span
											class="font-green"></span> <span class="font-green"></span>프<span
											class="font-green"></span>로<span class="font-green"></span>모<span
											class="font-green"></span>션<span class="font-green"></span> <span
											class="font-green"></span>중<span class="font-green"></span>단<span
											class="font-green"></span>안<span class="font-green"></span>내<span
											class="font-green"></span></a></th>
									<td>2022.05.06</td>
								</tr>
		...
		<div class="quick-area">
			<a href="https://www.megabox.co.kr/support/notice" class="btn-go-top"
