			...
			<div class="lnb-area addchat location-fixed">
				<nav id="lnb">
					...
					<ul>
						...
						<li class="on"><a href="http://localhost:8080/created2.action" title="1:1문의">1:1문의</a></li>
			...
			<div id="contents" class="location-fixed">
				...
				<div class="mypage-infomation mb30">
					...
					<div class="btn-group right">
						<a href="http://localhost:8080/list2.action" class="button purple" id="myQnaBtn" title="나의 문의내역 페이지로 이동">나의 문의내역</a><!-- btn-layer-open -->
					</div>
				</div>
