...
<div class="container has-lnb">
	...
	<a href="https://www.megabox.co.kr/mypage/myinquiry?cd=INQD01" title="1:1 문의내역 페이지로 이동">1:1 문의내역</a></div></div>
            </div>
	...
	<div class="lnb-area">
		<nav id="lnb">
			<p class="tit"><a href="https://www.megabox.co.kr/mypage" title="나의 메가박스">나의 메가박스</a></p>
						...
						<li><a href="http://localhost:8080/list.action" title="공지사항">공지사항</a></li>
						<li><a href="http://localhost:8080/created2.action" title="1:1문의">1:1문의</a></li>
						<li class="on"><a href="http://localhost:8080/list2.action" title="1:1문의">나의 문의내역</a></li>
...
<div id="contents" class="">
	...
	<div class="mypage-infomation mt20">
		...
		<div class="btn-group right">
			<a href="http://localhost:8080/created2.action" class="button" id="inqBtn" title="1:1 문의하기">1:1 문의하기</a>
		</div>
	</div>
