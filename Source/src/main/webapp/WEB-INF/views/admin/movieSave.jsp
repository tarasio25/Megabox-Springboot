...
<!-- 현우 -->
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="file" name="S_F_N" id="S_F_N"
					...
					<tr>
						...
						<td><input type="text" name="actress" id="actress"
							class="type01" style="width: 270px;"></td>
					</tr>
				</tbody>
			</table>
	...
	<div class="btn_center mt30" align="center">
		<button type="button" id="loginBtn" class="btn btn-warning" onclick="sendIt();">등록하기</button>
		<button type="button" onclick="location.replace('/movie/join')" class="btn btn-primary">작성취소</button>
