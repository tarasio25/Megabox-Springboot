...
<link rel="stylesheet" type="text/css" href="<%=cp%>/shoppingmall/product/product_files/reset.css" media="all">
<link rel="stylesheet" type="text/css" href="<%=cp%>/shoppingmall/product/product_files/style.css" media="all">
<link rel="stylesheet" type="text/css" href="<%=cp%>/shoppingmall/product/product_files/owl.carousel.min.css">
<!-- main slider css -->
		...
		<div class="contents">
			...
			<div class="content_area">
				...
				<div class="table_join">
					<form name="myForm" id="frmData" action="" method="post"
						...
						<table>
							...
							<tbody>
								<tr>
									<th style="padding-left: 20px;">브랜드</th>
									<td class="txt_color"><select name="brandNum"
										id="email_domain" class="type02">
											<option value="">브랜드</option>
											<c:forEach var="dto" items="${brandlists}">
												<option value="${dto.brandNum}">${dto.brandName}</option>
											</c:forEach>
									</select><input type="button" value="생성" class="btn-type post"
										style="width: 100px;"
										onclick="javascript:location.href='<%=cp%>/shop/product/brandSave.do?${params }';">
									</td>
								</tr>
								<tr>
									<th style="padding-left: 20px;">종류</th>
									<td class="txt_color"><select name="typeNum"
										id="email_domain" class="type02">
										...
										style="width: 100px;"
										onclick="javascript:location.href='<%=cp%>/shop/product/typeSave.do?${params }';" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									<th style="padding-left: 20px;">가격</th>
									<td><input type="text" name="price" id="changepw02"
										class="type01" style="width: 270px;"></td>
								</tr>
								<tr>
									<th style="padding-left: 20px;">일반 이미지</th>
									<td><input type="file" name="upload" id="changepw02"
										class="type01" style="width: 250px;"></td>
								</tr>
								<tr>
									<th style="padding-left: 20px;">상세 이미지</th>
									<td><input type="file" name="detailImage" id="changepw02"
										class="type01" style="width: 250px;"></td>
								</tr>
							</tbody>
						</table>
				...
				<div class="list_nbox">
					<!-- tab_wrap -->
					<div class="tab_wrap">
						<div class="tab_type_n"></div>
					</div>
					<!-- // tab_wrap -->
					<!-- select_custom_list -->
					<div class="select_custom_list"></div>
					<!-- // select_custom_list -->
					<!-- select_list -->
							...
							<div class="listbox">
								<a>
									...
									<div class="txt_box">
										...
										<div class="l_brandcode">${dto.brandName }&nbsp;${dto.typeName }</div>
										<div class="l_subj">${dto.subject }</div>
										<div class="l_price">${dto.price }
											<a
												href="<%=cp%>/shop/product/productDelete.do?num=${dto.num}&pageNum=${pageNum}"
